...
from basic_code import load, util, networks, model_eac
...
def main():
    ...
    list_train = './data/txt/ravdess_train.txt'
    batchsize_train= 48
    root_eval = './data/face/test_ravdess'
    list_eval = './data/txt/ravdess_eval.txt'
    batchsize_eval= 64

    train_loader, val_loader = load.rav_faces_baseline(root_train, list_train, batchsize_train, root_eval, list_eval, batchsize_eval)

    ''' Load model '''
    model = model_eac.Model(args)
    ...
    if args.evaluate == True:
        ...
        return
    logger.print('baseline rav dataset, learning rate: {:}'.format(args.lr))
