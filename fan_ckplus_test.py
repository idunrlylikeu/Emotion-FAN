...
def main():
    ...
    logger = util.Logger('./log/','evalrav_glass_4-1_alldata_train_fan_ckplus')
    ...
    _parameterDir = './model/self_relation-attention_10_100.0'
    ...
    if args.evaluate == True:
        ...
        return
    logger.print('frame attention network (fan) ravdess dataset, learning rate: {:}'.format(args.lr))
